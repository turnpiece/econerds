 ...
 * Econerds News.
 *
 * This file adds the custom CSS to the Econerds News Theme's custom WooCommerce stylesheet.
 *
 * @package News
 * @author  StudioPress
 * @license GPL-2.0+
...
function news_woocommerce_styles( $enqueue_styles ) {
	...
	$enqueue_styles['news-woocommerce-styles'] = array(
...
function news_woocommerce_css() {
	...
	', $color_accent, news_color_contrast( $color_accent ) ) : '';
