 ...
 * Econerds News.
 *
 * This file adds the required WooCommerce setup functions to the Econerds News Theme.
 *
 * @package News
 * @author  StudioPress
 * @license GPL-2.0+
...
function news_woocommerce_pagination( $args ) {
	...
	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'econerds-news' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'econerds-news' ) );
