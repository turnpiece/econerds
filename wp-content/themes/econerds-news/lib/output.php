 ...
 * Econerds News.
 *
 * This file adds the required CSS to the front end to the Econerds News Theme.
 *
 * @package News
 * @author  StudioPress
 * @license GPL-2.0+
...
function news_css() {
	...
	$css .= ( news_customizer_get_default_accent_color() !== $color_accent ) ? sprintf( '
		...
		', $color_accent, news_color_contrast( $color_accent ), news_change_brightness( $color_accent ) ) : '';
